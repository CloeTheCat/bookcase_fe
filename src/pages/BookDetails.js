...
function BookDetails({ bookData }) {
  ...
  if (bookData.addedOn !== null) {
    asideContent = <>
      <Card sx={cardStyle}>
        <p className={classes.userDetailsText}>Aggiunto alla tua libreria il {bookData.addedOn}</p>
        <p className={classes.userDetailsText}>Hai letto questo libro {bookData.readCount} volte.</p>
